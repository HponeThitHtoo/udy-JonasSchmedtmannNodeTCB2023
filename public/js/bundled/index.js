...
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1Ijoid2hpdGVudXp6bGUiLCJhIjoiY2p0dmEzZDBnMXYzMzRkbXMzNzFwYzN0MiJ9.f934_g4HohshrsDAh2FwXQ";
    var map = new mapboxgl.Map({
        container: "map",
        style: "mapbox://styles/whitenuzzle/clhehvr1f016501pg1svvhwvu",
        scrollZoom: false
    });
...
const logout = async ()=>{
    try {
        ...
        if (res.data.status === "success") location.reload(true); // reload from server, not from browser cache
    } catch (error) {
...
var Buffer = require("cb7ac022ecfb5021").Buffer;
"use strict";
/**
...
},{"cb7ac022ecfb5021":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("1b83e78bf9283762");
var ieee754 = require("fa8881901fda54f9");
...
},{"1b83e78bf9283762":"eIiSV","fa8881901fda54f9":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
const stripe = Stripe("pk_test_51HON8LHvrdhlhMdK8MBhglvApWC0a42aDjrEWh7AcLbJ2dW7if3BcccyD0emYEpq8FfjjJ2BNzoQQeTyVqisuiSh00wryEuW0E");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alert":"kxdiQ"}]},["5JCc9","f2QDv"], "f2QDv", "parcelRequire11c7")
